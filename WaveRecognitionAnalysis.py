...
def Blink():
   ...
   -EThe UpwardSpikeCH1 line for example uses the any() function to register the event when CH1 value
   ...
   """
    ...
    if ( UpwardSpikeCH1 ==True and UpwardSpikeCH4 == True ) :
     ...
     #There is a new element in the array every 3.9 ms.
        ...
        if ( DownwardSpikeCH1 == True and DownwardSpikeCH4 == True and WithinRangeCH3 == False) :
                    print("_____")
                    print("Blink") 
                    print("_____")
                    return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port",
                        type=int,
                        default=5051, #make sure you change the port every time you wanna run the code
